...
# FUNCTION TO GET WEATHER OF ANY CITY
def get_weather(city: str):
    """
    fetches current weather of the given city

    args:
    city(str): city name(eg: Kolkata)

    returns:
    dict: weather details in json format
    """
    try:
        api_key="20627439f3eba71c49235aa1c56759dc"
...
# GEMINI CODE TO USE THE FUNCTION TO GET THE DETAILS OF THE CITY
...
def get_news(topic: str):
    ...
    """
    try:
        api_key="3acf3f43ba0c4d23a2ffbd67fc14cb34"
        url= f"https://newsapi.org/v2/everything?q={topic}&apiKey={api_key}&pageSize=4&sortBy=publishedAt"
        response =requests.get(url)
...
def find_local_events(city: str):
    ...
    args:
    city(str):city name (eg :- Kolkata , Delhi)
    """

    try:
        api_key="5f759ab6f5dddfd51541c3a71fb0beb137ae9447cf4dbd8635b7aab64efc1869"
